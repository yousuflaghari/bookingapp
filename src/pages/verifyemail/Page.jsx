  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      <Section>
        ...
        <Description>Enter the 6-digit code sent to your email to complete registration.</Description>
        ...
        <FormWrapper>
          ...
          <form onSubmit={handleSubmit}>
            <Input 
              ...
              maxLength={6}
            />
            <CTAButton type="submit">Verify Email</CTAButton>
          </form>

          <ResendLink onClick={handleResend}>Resend Code</ResendLink>
          <Note>Check your spam/junk folder if you did not receive the code.</Note>
        </FormWrapper>
      </Section>
