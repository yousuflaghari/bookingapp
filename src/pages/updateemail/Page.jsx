  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      <Section>
        ...
        <Description>Change your account email for account notifications and login. Make sure the new email is valid.</Description>
        ...
        <FormWrapper>
          ...
          <form onSubmit={handleSubmit}>
            ...
            />
            <CTAButton type="submit">Update Email</CTAButton>
          </form>

          <Note>After updating, you will receive a verification email at your new address.</Note>
        </FormWrapper>
      </Section>
