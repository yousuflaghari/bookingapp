...
const SimilarHotelsPage = () => {
  const allHotels = Array.from({ length: 50 }, (_, i) => ({
    ...
    image: `https://picsum.photos/300/180?random=${i+600}`
  }));
  ...
  const currentItems = hotels.slice(indexOfFirst,indexOfLast);
  const totalPages = Math.ceil(hotels.length/itemsPerPage);

  return (
    <Wrapper>
      <Title>Similar Hotels</Title>
      <FilterSection>
...
export default SimilarHotelsPage;